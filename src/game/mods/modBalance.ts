...
export const MOD_BALANCE = {
  ...
  infusionPlasmaCost: {
    'enemy-growth': 300,
    'detonation-fireworks': 350,
    'prismatic-rounds': 375,
    'holo-afterimage': 400,
    'pickup-orbit': 325,
    'ghost-echoes': 425,
    'arcade-pop': 350
  } as const,
  infusionReconfigurationPlasmaCost: 90,
  infusionRemovalPlasmaCost: 60,
  ...
  rarityWeights: { common: 56, uncommon: 27, rare: 12, epic: 4.5, legendary: 0.5, supreme: 4.5 } satisfies Record<ModRarity, number>,
  raritySourceMultipliers: {
    normalEnemy: { common: 1, uncommon: 0.65, rare: 0.25, epic: 0, legendary: 0, supreme: 0.08 },
    eliteEnemy: { common: 0.7, uncommon: 1, rare: 1.4, epic: 0.8, legendary: 0.2, supreme: 0.7 },
    milestone: { common: 0.5, uncommon: 1, rare: 1.7, epic: 1.5, legendary: 0.5, supreme: 1.35 },
    boss: { common: 0.08, uncommon: 0.18, rare: 0.8, epic: 2.2, legendary: 18, supreme: 2.4 },
...
const BASE_RUN_PROTOCOLS = {
  normal: { id: 'normal', family: 'normal', tier: 0, label: 'NORMAL PROTOCOL', description: 'POWER FANTASY // Checkpoint starts unlock every 10 cleared rounds. Supreme Mods offline.', unlockHighestRound: 0, startingRound: 1, scoreMultiplier: MODE_BALANCE.normal.scoreMultiplier, modDropMultiplier: MODE_BALANCE.normal.modDropChanceMultiplier },
  ...
  'overdrive-lyra': { id: 'overdrive-lyra', family: 'overdrive', tier: 4, label: 'OVERDRIVE LYRA', description: regularOverdriveDescription(20), unlockHighestRound: 23, startingRound: 20, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-draco': { id: 'overdrive-draco', family: 'overdrive', tier: 5, label: 'OVERDRIVE DRACO', description: regularOverdriveDescription(25), unlockHighestRound: 28, startingRound: 25, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-phoenix': { id: 'overdrive-phoenix', family: 'overdrive', tier: 6, label: 'OVERDRIVE PHOENIX', description: regularOverdriveDescription(30), unlockHighestRound: 33, startingRound: 30, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-hydra': { id: 'overdrive-hydra', family: 'overdrive', tier: 7, label: 'OVERDRIVE HYDRA', description: regularOverdriveDescription(35), unlockHighestRound: 38, startingRound: 35, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-andromeda': { id: 'overdrive-andromeda', family: 'overdrive', tier: 8, label: 'OVERDRIVE ANDROMEDA', description: regularOverdriveDescription(40), unlockHighestRound: 43, startingRound: 40, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-perseus': { id: 'overdrive-perseus', family: 'overdrive', tier: 9, label: 'OVERDRIVE PERSEUS', description: regularOverdriveDescription(45), unlockHighestRound: 48, startingRound: 45, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-pegasus': { id: 'overdrive-pegasus', family: 'overdrive', tier: 10, label: 'OVERDRIVE PEGASUS', description: regularOverdriveDescription(50), unlockHighestRound: 53, startingRound: 50, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier }
