...
export const RUN_PROTOCOLS: Record<RunProtocolId, RunProtocolDefinition> = {
  ...
  'overdrive-ares': { id: 'overdrive-ares', family: 'overdrive', tier: 3, label: 'OVERDRIVE ARES', description: 'SURVIVAL // Begin at Round 15. Deadlier threats, x2 boosts, improved Mods.', unlockHighestRound: 18, startingRound: 15, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-lyra': { id: 'overdrive-lyra', family: 'overdrive', tier: 4, label: 'OVERDRIVE LYRA', description: 'SURVIVAL // Begin at Round 20. Deadlier threats, x2 boosts, improved Mods.', unlockHighestRound: 23, startingRound: 20, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-draco': { id: 'overdrive-draco', family: 'overdrive', tier: 5, label: 'OVERDRIVE DRACO', description: 'SURVIVAL // Begin at Round 25. Deadlier threats, x2 boosts, improved Mods.', unlockHighestRound: 28, startingRound: 25, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-phoenix': { id: 'overdrive-phoenix', family: 'overdrive', tier: 6, label: 'OVERDRIVE PHOENIX', description: 'SURVIVAL // Begin at Round 30. Deadlier threats, x2 boosts, improved Mods.', unlockHighestRound: 33, startingRound: 30, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
  'overdrive-hydra': { id: 'overdrive-hydra', family: 'overdrive', tier: 7, label: 'OVERDRIVE HYDRA', description: 'SURVIVAL // Begin at Round 35. Deadlier threats, x2 boosts, improved Mods.', unlockHighestRound: 38, startingRound: 35, scoreMultiplier: MODE_BALANCE.overdrive.scoreMultiplier, modDropMultiplier: MODE_BALANCE.overdrive.modDropChanceMultiplier },
