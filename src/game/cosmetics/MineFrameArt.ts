...
const MINE_FRAME_MARKUP: Record<MineFrameArtId, string> = {
  ...
  `,
  'roll-station': `
    <ellipse class="mf-shadow" cx="100" cy="146" rx="73" ry="16"/><path class="mf-side" d="m24 49 132-15 20 85-130 25z"/>
    <path class="mf-tray" d="m20 39 137-15 18 84-137 24z"/><path class="mf-tray-inset" d="m35 52 110-13 13 57-108 19z"/>
    <g class="mf-herb"><path d="m62 73 5-14 6 14 13-5-5 12 13 6-15 3 1 14-10-10-10 10 2-15-14-2 13-6-10-10zM120 58l4-11 5 10 10-4-4 10 10 4-11 3 1 10-8-7-8 8 2-11-11-2 10-5-7-7z"/></g>
    <path class="mf-paper" d="m62 101 65-13 12 17-65 12z"/><path class="mf-line" d="m68 102 63-12M72 108l64-12"/>
    <circle class="mf-grinder" cx="142" cy="61" r="17"/><path class="mf-grinder-teeth" d="m142 47 4 9 10 1-8 7 2 10-8-5-9 5 2-10-8-7 11-1z"/><circle class="mf-core" cx="93" cy="79" r="9"/>
  `,
  watcher: `
