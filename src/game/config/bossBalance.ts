...
export const BOSS_BALANCE = {
  ...
  rewardPlasmaChipsBase: 4,
  rewardPlasmaChipsPerTier: 2,
  rewardPlasmaChipsMaximum: 14,
  supportPickupFirstDelayMs: 700,
  supportPickupMinimumIntervalMs: 5000,
  supportPickupMaximumIntervalMs: 7500,
