export const FLUX_CORE_BALANCE = {
  ...
  perCoreSpawnMinMs: 1400,
  perCoreSpawnMaxMs: 3400,
  laserOnlineGraceMs: 15_000,
  nextCycleVarianceMinMs: 1800,
  nextCycleVarianceMaxMs: 9000,
  lowRoundMaximum: 3,
  absoluteMaximum: 6,
  ...
  recentLocationSpacing: 120,
  recentLocationMemory: 12,
  geometryHalfWidth: 38,
  geometryHalfHeight: 46,
  bombSiteExclusionRadius: 108,
  collectibleDropChance: 0.42,
  destructionParticleCount: 18,
  floorRiseMs: 1200,
  windowOpenMs: 620,
