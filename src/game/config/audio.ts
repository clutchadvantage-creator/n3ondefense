export const SFX_DEFINITIONS = [
  ...
  { key: 'overloadEvent', label: 'Overload Event' },
  { key: 'supplyDropEvent', label: 'Supply Drop Event' },
  { key: 'anomalyPortalPower', label: 'Anomaly Energy Feed' },
  { key: 'anomalyPortalIdle', label: 'Anomaly Portal Idle' },
  { key: 'anomalyPortalTransit', label: 'Anomaly Portal Transit' },
  { key: 'heistDoor', label: 'HEIST Security Door' },
  { key: 'heistAlarm', label: 'HEIST Escape Alarm' },
  { key: 'dataThiefEntrance', label: 'Data Thief Entrance' },
