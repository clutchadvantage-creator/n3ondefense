...
export const COSMETICS: CosmeticOption[] = [
  ...
  { id: 'mine-roll-station', category: 'mineFrame', label: 'ROLL STATION', currency: 'credits', cost: 15_000, additionalCosts: { coreTokens: 300, plasmaChips: 45 }, color: 0x72ff82, accentColor: 0xb66cff, previewColor: 0x72ff82, textureKey: 'mine-frame-roll-station', priceTier: 'prestige', mineFrameEffect: 'roll-station', description: 'A chamfered rolling tray loaded with luminous herb fragments, paper hardware, a compact grinder, and a suspiciously hot center module.' },
