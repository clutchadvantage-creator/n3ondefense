...
const before = await read('artifacts/layout-after.json');
const after = await read('artifacts/polish-layout-after.json');
const failures = [];
...
await writeFile('docs/polish-layout-measurements.json', JSON.stringify(summary, null, 2) + '\n');
